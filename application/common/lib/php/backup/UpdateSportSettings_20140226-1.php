  ...
  include("../../../../config/parameter.ini");
    ...
    // 產生縮點座標，圖片，先撈出經緯度
     echo "訓練id:".$trainID."<p>";      
      ...
      include ("$work_path/php/reduce_point/reduce.php");    // 縮點還要，縮圖改用 google 內建函數
      //include ("$work_path/php/reduce_point/thumbnail.php");         
	//	}else{
//			$upadtePostime="";
//		}
		...
		*/
		$imageDir=$webImagePath.'/'.$trainID;
		checkdirexit($imageDir);
		$img = $imageDir.'/RoutePath.jpg';
