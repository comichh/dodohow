/*
  ...
  Demo http://www.dynarch.com/static/jscalendar-1.0/index.html
  完整的參數說明  http://www.dynarch.com/static/jscalendar-1.0/doc/html/reference.html
  

js 檔
$(document).ready(function(){
	         $("#text1").dynDateTime({
                 ifFormat:"%Y-%m-%d [%W] %H:%M",
                   showsTime: true 
           });
});

html  檔案 ，注意還有一個語系檔，和一個 css 檔

<?php
echo "<script type='text/javascript' src='../jquery/1.8.3'></script>";
echo "<script type='text/javascript' src='../jquery/plugin/dynDateTime/JS/jquery.dynDateTime.js'></script>";
echo "<script type='text/javascript' src='js/test.js'></script>";
echo "<script type='text/javascript' src='../jquery/plugin/dynDateTime/lang/calendar-utf8-tw.js'></script>";
?>
