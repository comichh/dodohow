				...
				if(jsonArray[0].Detail!=''){
					...
					switch(true){
						case (BergwertungScore<=19):
							imgurl='./images/green-ball.png';
							imgdiv=getBergwertungDivHtml(imgurl,titleBergwertungLV4);
							break;
						case (BergwertungScore<=49):
							imgurl='./images/blue-ball.png';
							imgdiv=getBergwertungDivHtml(imgurl,titleBergwertungLV3);
							break;
						case (BergwertungScore<=119):
							imgurl='./images/yellow-ball.png';
							imgdiv=getBergwertungDivHtml(imgurl,titleBergwertungLV2);
							break;
						case (BergwertungScore<=199):
							imgurl='./images/purple-ball.png';
							imgdiv=getBergwertungDivHtml(imgurl,titleBergwertungLV1);
							break;
						default:
							imgurl='./images/red-ball.png';
							imgdiv=getBergwertungDivHtml(imgurl,titleBergwertungLV0);
							break;	
					}
...
function getBergwertungDivHtml(imgurl,desc){
	return '<div style="font-size:12px;color:#262626;font-weight:900">'+titleSectionsDifficulty+':<img src="'+imgurl+'" width=20 />'+desc+'</div>';
}
...
function getSlopeProportion(){
	...
	if(heightLength>0){
		...
		//return getBergwertung(maxElevation,height[0],totalDistance,sqrvalue,totalEachValue,upDistance);
	}
}

//Bergwertung=((平均坡度(%))^(3/2*坡度比例)*總爬升量(公尺))/100
//function getBergwertung(maxHeight,startHeight,totalDistance,sqrvalue,totalEachValue,upDistance){
function getBergwertung(difficultRoad){	
	...
	return (Math.pow(Math.abs(maxHeight-startHeight)/totalDistance,sqrfeed)*upDistance)/100;
