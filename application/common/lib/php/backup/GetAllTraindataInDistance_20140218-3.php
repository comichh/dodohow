<?php
	...
	try {
		...
		$sqlstr.=" SELECT b.creator, c.displayname, c.image, a.Start_time, a.id,a.deviceid,a.train_name,a.post_datetime,a.train_description, a.wTotalPoint, a.lTotalTime, a.lTotalDistance";
