	...
	$.ajax({
		...
		success: function(Jdata) {
			...
			for(var index=0;index<dataLength;index++){
				...
				contentStr+="Trainname:'<span style=\"cursor:pointer\" onclick=\"showDetail("+index+")\">"+objectData[index].Trainname+"</span>',";
				contentStr+="StartTime:'"+objectData[index].StartTime+"',"
				contentStr+="Description:'"+objectData[index].Description+"',";
				contentStr+="TotalTime:"+objectData[index].TotalTime+",";
