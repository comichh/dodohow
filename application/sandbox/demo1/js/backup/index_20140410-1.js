...
$(function(){
	...
	$('#reSort').click(function(){
		...
		$('#ScrollFrame').attr('src',"scrollframe.php?SearchMode=2&type="+searchRunType+"&sortName="+selectSortValue+"&findUserName="+userName+"&keyword="+searchByKeywordVal+"&startDate="+startDate+"&endDate="+endDate);
		$('#SortCollection').hide();
	});
	...
	$('#FindByFilter').click(function(){
		...
		var startDate=$('#date_start').val();
		var endDate=$('#date_end').val();
		$('#ScrollFrame').attr('src',"scrollframe.php?SearchMode=3&type="+searchRunType+"&findUserName="+userName+"&keyword="+searchByKeywordVal+"&startDate="+startDate+"&endDate="+endDate);
		$('#DeepSearch').hide();
		advenceSearch();
