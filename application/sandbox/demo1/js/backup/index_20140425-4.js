				...
				if(jsonArray[0].Detail!=''){
					...
					switch(true){
						case (BergwertungScore<=19):
							imgdiv=getBergwertungDivHtml(1,titleBergwertungLV4);
							break;
						case (BergwertungScore<=49):
							imgdiv=getBergwertungDivHtml(2,titleBergwertungLV3);
							break;
						case (BergwertungScore<=119):
							imgdiv=getBergwertungDivHtml(3,titleBergwertungLV2);
							break;
						case (BergwertungScore<=199):
							imgdiv=getBergwertungDivHtml(4,titleBergwertungLV1);
							break;
						default:
							imgdiv=getBergwertungDivHtml(5,titleBergwertungLV0);
							break;	
					}
...
function getBergwertungDivHtml(level,desc){
	var imageurl='';
	for(var i=0;i<level;i++){
		imageurl+='<img src="./images/star.png" width=20 />'
	}
	return '<div style="font-size:12px;color:#262626;font-weight:900">'+titleSectionsDifficulty+':'+imageurl+desc+'</div>';
}
