		...
		$.ajax({
			...
			success: function(Jdata) {
				...
				for(var index=0;index<dataLength;index++){
					...
					contentStr+="StartLongitude:"+objectData[index].StartLongitude+",";
					contentStr+="CommentCount:"+objectData[index].CommentCount+",";
					contentStr+="PraiseCount:'<img src=\"./images/good.png\" width=24 height=24 /><div>0</div>',";
					contentStr+="CollectCount:'<img src=\"./images/plus.png\" width=24 height=24 onclick=\"addMySportList("+urd+","+index+")\"/><div id=\"FavCount_"+index+"\">"+objectData[index].FavSportList+"</div>'";
					contentStr+="},";
				}
				contentStr = contentStr.substr(0,contentStr.length-1);
				newJsonStr="["+contentStr+"]";
