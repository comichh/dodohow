...
function putActivityOnMap(){
	...
	for(var i=0;i<len;i++){
		...
		targethtml+='	<tr><td width="30%"><div style="height:60px;position:relative;left:5px"><img style="max-height:60px" src="'+result[i].image+'" width="60"></div></td><td><div style="font-size:12px;color:#262626;font-weight:900">'+ titleCumulativeTime+':783:15:36</div><div style="color:#262626;font-size:12px;font-weight:900">'+titleCumulativeDistance+':265km</div><div style="color:#262626;font-size:12px;font-weight:900">'+titleHighestElevation+':323m</div><div style="color:#262626;font-size:12px;font-weight:900;">'+titleCumulativeAscent+':156km</div><div style="position:absolute;left:200px;top:30px"><img src="./images/'+sportTypeImage+'" width="40"></div></td></tr>';
		...
		targethtml+='	<tr><td valign="top"><div style="font-size:12px;color:#ffffff;height:20px">'+titleTotalTime+'：'+getSportTime(result[i].lTotalTime)+'</div><div style="font-size:12px;color:#ffffff;height:20px">'+titleTotalDistance+'：'+getDistanceKmValue(result[i].lTotalDistance)+' km</div><div style="font-size:12px;color:#ffffff;height:20px">'+titleTotalCalory+'：'+result[i].Calory+' cal</div><div style="font-size:12px;color:#ffffff;height:20px">'+titleSectionsDifficulty+'：★★★★★</div></td><td align="right"><img src="'+routeImageBaseUrl+'/'+result[i].id+'.jpg" style="border:1px #cecece solid" width="80"></td></tr>'
		targethtml+='	<tr><td valign="top" colspan=2><div style="position:relative;top:10px"><img src="./images/msgbox_down.png" width="200"/></div></tr>'
