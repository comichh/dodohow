...
GPXParser.prototype.getRouthPolylineRef = function() {
    return this.polyline;
}

GPXParser.prototype.getPointArray = function() {
    return this.resultPointArray;
}
...
GPXParser.prototype.addTrackSegmentToMap = function(trackSegment, colour,
	...
	var elepoints = trackSegment.getElementsByTagName("ele");
    var pointarray = [];
    pointLocationArray = [];
    // process first point
    ...
    for(var i = 0; i < trackpoints.length; i++) {
		...
		ele = parseFloat(elepoints[i].childNodes[0].nodeValue);
		pointarray.push(new google.maps.LatLng(lat,lon));
		pointLocationArray.push({
			location:{
				latValue:lat,
				lngValue:lon,
				eleValue:ele,
	...
	routePolyline.setPath(pointarray);
	routePolyline.setMap(this.map);
	outSourceMarker[0].setPosition(pointarray[0]);
	outSourceMarker[0].setVisible(true);
	outSourceMarker[1].setPosition(pointarray[pointarray.length-1]);
	outSourceMarker[1].setVisible(true);
	/*
	...
	*/
	//this.resultPointArray=pointLocationArray;
}
