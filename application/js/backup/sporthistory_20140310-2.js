			 	...
			 	if(jsonArray[0].Detail!=''){
					...
					*/
					...
					for(var index=0;index<detailObj.length;index++){
						...
						datetimeObj.push(detailObj[index].start_time);
					}
...
function getDatetimeValue(datetime1,datetime2){
	var first = splitDatetime(datetime1); // Get the first date epoch object
    var second = splitDatetime(datetime2); ; // Get the first date epoch object
    return second - first ;
}
