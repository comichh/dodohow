...
$(function(){
  $("#list").jqGrid({
		...
		onSelectRow: function(rowID) {
			var indexID=rowID-1;
            setMapRoutePath(displayData[indexID].StartLatitude,displayData[indexID].StartLongitude,displayData[indexID].trainid,displayData[indexID].deviceid);
        }
	});
...
function setMapRoutePath(lat,lng,tripID,deviceID){
	window.parent.locateMapRoutePathAndPosition(lat,lng,tripID,deviceID);
}
