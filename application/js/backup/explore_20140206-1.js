				...
				for(var i=0;i<totalcount;i++){             
					...
					google.maps.event.addListener(marker, 'click', (function(marker, tripID, deviceID,imageName,trainName,fullname,lTotalDistance,lTotalTime) {            
						 return function() {  
							...
							activityWindow.setContent('<table><tr><td><img src="./upload/upload/'+imageName+'" width="120" style="border:1px #cecece solid"></td></tr><tr><td>'+fullname+'</td></tr><tr><td>'+trainName+'</td></tr><tr><td>'+lTotalDistance+'</td></tr><tr><td>'+lTotalTime+'</td></tr><tr><td><span class="badge badge-success" style="cursor:pointer;" onclick="getHistoryByAjax('+tripID+',\''+deviceID+'\')">詳細資料</span></td></tr></table>');
