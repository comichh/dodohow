...
function putActivityOnMap(){
	...
	for(var i=0;i<len;i++){
		...
		singleData.push(0);
		singleData.push('<div><img src="'+result[i].image+'" width=60 style="position:relative;top:30px;left:15px"></div>');
...
function createMarker(site, map){
	...
	boxText.style.cssText = "border-radius:10px; width:270px;height:336px;border: 1px solid black; margin-top: 8px; background: yellow; padding: 5px;background:url(./images/big.jpg)";
