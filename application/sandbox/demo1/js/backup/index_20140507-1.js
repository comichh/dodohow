...
function initialize(lat,lng) {
	...
	shareMarker = new google.maps.Marker({
	  ...
	  icon:'./images/Active_Marker_1.png'
	}); 
}
...
function getImageIconUrl(index){
	switch(parseInt(index)){
	    ...
	    return './images/run_google_icon.png';
			break;
		case 2:
			//return './images/Green.gif';
         return './images/bike_google_icon.png';
			break;
		default:
			//return './images/info.gif';
      return './images/run_google_icon.png';
...
function createMarker(site, map,sportTypeID){
	...
	boxText.style.cssText = "border-radius:10px;width:250px;height:330px;margin-top: 8px;padding:5px;background:url(./images/big_1.png);background-repeat:no-repeat;";
