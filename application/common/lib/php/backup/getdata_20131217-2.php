<?php
	...
	try {
		$sqlstr.="select b.id,b.start_time,b.latitude,b.longitude,b.altitude,b.speed,b.heart_rate,b.cadence,b.pwr_cadence,b.power,b.distance from tbl_train_data a,gsgh_625xt12W32A0000023 b where a.id=b.train_data_key and a.id=".$tripID;
