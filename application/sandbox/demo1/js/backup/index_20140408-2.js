...
var train_fullname=result[index].fullname;
$("#show_vscroll_div").html("<iframe src='Vscrollframe.php?id="+train_id+"&fullname="+train_fullname+"' scrolling='no' allowtransparency='true' style='background-color:#efefef;border:none;height:100%;width:100%;text-align:center'></iframe>");
