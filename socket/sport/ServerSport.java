               ...
               // 目前只有環天的機器，整個架構都是以目前環天可用的作法判斷而已
                 ...
                 switch(globalsat)
                 {
                    ...
                    case '@':            // train data                                     
                        ...
                        check_app=imei.indexOf("GH208gRun"); 
                    ...
                    case '$':        // point data
                       ...
                       if (diff >0){         // 只要是負的就應該跳離，不可能會有未來日期
                         if ( check_app == -1){               // 不是 app ，app 經緯度不轉換                                                                           
                           try{            // 經緯度格式轉換        
                       ...
                       try {
                         ...
                         try {
                          ...
                          {   
                             ...
                             SR_data=SR_data+rs.getString(6)+";"+""+";"+id_combian+",";     //改成撈id ，經緯度直接存在另一個資料表  
                             a=a+1;      
                          }
                          } catch (Exception e) {
                      ...
                      case 'G':                                // 路徑規劃,實際分辨是 GR，開始傳每一筆路徑的座標
                          ...
                          try {                           
                            ...
                            while(rs.next())
                            {
                               ...
                               GR_data=GR_data+rs.getString(5)+";"+rs.getString(6)+",";   
                               b=b+1;      
                            }
