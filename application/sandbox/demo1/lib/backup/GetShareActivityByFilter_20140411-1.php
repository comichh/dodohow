<?php
	...
	try {
		...
		switch($sortType){
			...
			case "3":
				...
				break;
			case "4":
				$sqlstr=getSpecialSortSQL("tbl_praise","praise_train_key",$timeRange,$distanceRangeStart,$distanceRangeEnd);
				/*
				...
				*/
				break;
			case "5":
				$sqlstr=getSpecialSortSQL("tbl_planning","tain_planning",$timeRange,$distanceRangeStart,$distanceRangeEnd);
				/*
	...
	function getSpecialSortSQL($joinTable,$colName,$timeRange,$distanceRangeStart,$distanceRangeEnd){
