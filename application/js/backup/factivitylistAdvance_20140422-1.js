		...
		$.ajax({
			...
			success: function(Jdata) {
				...
				for(var index=0;index<dataLength;index++){
					...
					contentStr+="Detail:'<img src=\"../upload/point_thumbnail/"+objectData[index].id+".jpg\" style=\"width:120px;border:1px #cecece solid\"/>',";
					contentStr+="Description:'"+objectData[index].train_description+"',";
					if(parseInt(objectData[index].PictureCount)>0){
						//contentStr+="Photo:'<div align=\"center\"><a href=\"galleryAblum.php?tripID="+objectData[index].id+"\" target=\"_blank\"><img src=\"./images/photocollect.png\" width=\"28\" /></a><br/>("+objectData[index].PictureCount+")</div>',";
