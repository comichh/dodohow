...
$(function(){
  $("#list").jqGrid({
		...
		colModel:[ 
			...
			{name:'PraiseCount',index:'PraiseCount', width:60,align:"center",search:false},
			{name:'CollectCount',index:'CollectCount', width:60,align:"center",search:false}
		], 
		pager: '#pager',
		viewrecords: true,
		hidegrid: false,
		...
		$.ajax({
			...
			success: function(Jdata) {
				...
				for(var index=0;index<dataLength;index++){
					...
					contentStr+="Detail:'<div align=\"center\" style=\"cursor:pointer\" onclick=\"showDetail("+index+")\"><img src=\"../upload/point_thumbnail/"+objectData[index].trainid+".jpg\" style=\"width:200px;border:1px #cecece solid\"/></div>',";
